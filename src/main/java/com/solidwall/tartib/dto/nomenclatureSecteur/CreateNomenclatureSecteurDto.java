...
@Data
@Slf4j
public class CreateNomenclatureSecteurDto {
    @NotBlank
    private String code;
    ...
    @JsonIgnore
    public List<CreateSecteurDto> getSecteursList() {
        try {
            ...
            return mapper.readValue(secteurs, 
                mapper.getTypeFactory().constructCollectionType(List.class, CreateSecteurDto.class));
        } catch (Exception e) {
